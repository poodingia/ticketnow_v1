...
import {useAdminStats} from "@/hooks/useFetch";
import Loading from "./loading";

export default function Dashboard() {
  const { data: dashboardData, isPending } = useAdminStats()
      ...
      <div className="flex flex-col">
        ...
        <main className="container mx-auto flex-1 space-y-6 p-4 md:p-8">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Doanh thu trên từng vé</CardTitle>
                <DollarSign className="h-4 w-4 text-muted-foreground"/>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold tracking-tight text-primary">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="md:col-span-7 hover:shadow-lg transition-shadow">
              <CardHeader>
                <CardTitle>Số lượng từng loại vé bán ra</CardTitle>
                <CardDescription>Top loại vé theo số lượng bán ra</CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <ResponsiveContainer width="100%" height={400}>
                  <RechartsBarChart

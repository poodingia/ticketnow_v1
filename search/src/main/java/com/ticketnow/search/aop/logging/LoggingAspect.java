package com.ticketnow.search.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.ticketnow.search..*)"
            + "|| within(com.ticketnow.search.service..*)"
            + "|| within(com.ticketnow.search.rest..*)"
            + "|| within(com.ticketnow.search.repo..*)")

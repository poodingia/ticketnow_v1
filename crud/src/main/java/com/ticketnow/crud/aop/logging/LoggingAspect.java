package com.ticketnow.crud.aop.logging;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.ticketnow.crud..*)"
            + "|| within(com.ticketnow.crud.service..*)"
            + "|| within(com.ticketnow.crud.rest..*)"
            + "|| within(com.ticketnow.crud.repos..*)"
            + "|| within(com.ticketnow.crud.mapper..*)"
            + "|| within(com.ticketnow.crud.exception.handler..*)")

package com.ticketnow.gateway.config;
...
public class SecurityConfig {
    ...
    private ServerLogoutSuccessHandler oidcLogoutSuccessHandler() {
        ...
        oidcLogoutSuccessHandler.setPostLogoutRedirectUri("http://localhost:28080");
